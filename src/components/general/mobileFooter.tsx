                        ...
                        <div className="footer-column">
                            <div className="footer-column__row">
                                <div className="logo-block">
                                    <img className='logo-block__img' src='/assets/images/3.1 Лого Султан RGB (1).svg' alt="" />
                                </div>
                                <Link to={'/'} className='app-btn'>Прайс лист<img className='app-btn__icon' src='/assets/images/Vector (4).svg' alt="" /></Link>
                            </div>
