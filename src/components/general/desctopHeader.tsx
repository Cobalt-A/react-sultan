          ...
          <div className="row">
            <div className="col-xxl-6 col-lg-12 upper-header-col">
              <div className="info-block">
                <img
                  className="info-block__icon"
                  src="/assets/images/akar-icons_location.svg"
                  alt=""
                  height={"16px"}
                  width={"auto"}
                />
              ...
              <div className="info-block">
                <img
                  className="info-block__icon"
                  src="/assets/images/fluent_mail-24-regular.svg"
                  alt=""
                  height={"16px"}
                  width={"auto"}
                />
        ...
        <div className="container">
          <div className="row">
            <div className="bottom-header-row">
              ...
              <Link className="app-btn bottom-header-row__item" to={"/"}>
                Каталог
                <img
                  className="app-btn__icon"
                  src="/assets/images/Frame 125.svg"
                  alt=""
                />
              </Link>
              ...
              <div className="work-time-block bottom-header-row__item">
                <p className="work-time-block__content">
                  ...
                  <br />
                  <Link className="work-time-block__link" to={"/"}>
                    Заказать звонок
                  </Link>
                </p>
              ...
              <Link
                className="app-btn price-btn bottom-header-row__item"
                to={"/"}
              >
                Прайс лист
                <img
              ...
              <Link
                to={"/order"}
                className="order-block bottom-header-row__item"
              >
                <div className="order-block__icon">
                  <img
                    src="/assets/images/simple-line-icons_basket.svg"
                    alt=""
                  />
