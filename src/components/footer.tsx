					...
					<div className="row">
						...
						<div className="col-xxl-3 col-lg-12">
							...
							<div className="footer-column promo-column">
								<div className="logo-block">
									<img src={require('../assets/images/3.1 Лого Султан RGB (1).svg').default} alt="" />
								</div>
								...
								<form className='email-form' action="">
									...
									<button className='email-form__button'>
										<img className='email-form__icon' src={require('../assets/images/Vector (5).svg').default} alt="" />
									</button>
								</form>
							</div>
						...
						<div className="col-xxl-3 col-lg-6">
							...
							<div className="footer-column">
								...
								<Link to={'/'} className='app-btn footer-column__btn'>Прайс лист<img className='app-btn__icon' src={require('../assets/images/Vector (4).svg').default} alt="" /></Link>

								<div className="socials">
									<p className='socials__title'>Связь в мессенджерах:</p>
									<ul className='socials-menu'>
										<li className='socials-menu__item'><Link className='socials-menu__link' to={'/'}><img src={require('../assets/images/logos_telegram.svg').default} alt="" /></Link></li>
										<li className='socials-menu__item'><Link className='socials-menu__link' to={'/'}><img src={require('../assets/images/Group 162.svg').default} alt="" /></Link></li>
									</ul>
								</div>
						...
						<div className="col-xxl-2 col-lg-6">
							...
							<div className="footer-column">
								...
								<ul className="cards-list">
									<li className="cards-list__item"><img src={require('../assets/images/Visa.svg').default} alt="" /></li>
									<li className="cards-list__item"><img src={require('../assets/images/Visa (1).svg').default} alt="" /></li>
								</ul>
				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-12">
							...
							<div className="footer-column">
								<div className="footer-column__row">
									<div className="logo-block">
										<img className='logo-block__img' src={require('../assets/images/3.1 Лого Султан RGB (1).svg').default} alt="" />
									</div>
									<Link to={'/'} className='app-btn'>Прайс лист<img className='app-btn__icon' src={require('../assets/images/Vector (4).svg').default} alt="" /></Link>
								</div>
								<p className="footer-column__text">
									Компания «Султан» — снабжаем розничные магазины товарами "под ключ" в Кокчетаве и Акмолинской области
								</p>
