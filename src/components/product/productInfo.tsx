		...
		<div className="product-info">
            ...
            <div className="product-info__row">
                ...
                <div className="product-price">
                    <p data-testid="price" className='product-price__price'>{product.price} {product.currency}</p>
                </div>

                <div className="order-amount">
                    <button data-testid="deleteOrder" onClick={deleteOrder} className='order-amount__btn order-amount__decrease'>-</button>
                    <p data-testid="amount" className='order-amount__amount'>{orders.filter(el => el === id).length}</p>
                    <button data-testid="addOrder" onClick={addOrder} className='order-amount__btn order-amount__increase'>+</button>
                </div>

                <button data-testid="order" onClick={addOrder} className='order-button'>
                    В корзину
                    <img className='order-button__icon' src='/assets/images/simple-line-icons_basket (1).svg' alt="" />
                </button>
                ...
                <button className="price-list">
                    Прайс-лист
                    <img className='price-list__icon' src='/assets/images/bx_bxs-download.svg' alt="" />
                </button>
